...
//   const cart = await (await Cart.findOneAndRemove({orderdBy:user._id})).exec()
...
console.log("NEW ORDER", newOrder)
 //decrement CART quantity of product , increment sold------> bulk write(can be messy)
...
// post - addTOSet special method no duplicates
...
exports.createCashOrder= async (req,res) => {
  ...
  //cod true - order status - Cash on delivery
